  ...
  <div class="card table-main">
    ...
    >
      ...
      >
        ...
        <TableColumn
          v-if="
            !item.type && item.prop && item.isShow
          "
          :column="item"
        >
          <template
...
watch(() => props.initParam, getTableList, {
  deep: true
});
...
const flatColumnsFunc = (
  ...
  return flatArr.filter(
    item => !item._children?.length
  );
};

// flatColumns
const flatColumns = ref<ColumnProps[]>();
flatColumns.value = flatColumnsFunc(
  tableColumns.value
);
