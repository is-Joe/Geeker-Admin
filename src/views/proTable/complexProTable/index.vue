    ...
    >
      ...
      <template #tableHeader="scope">
        <el-button
          ...
          :icon="CirclePlus"
          @click="
            proTable?.element?.toggleAllSelection
          "
        >
          全选 / 全不选
        </el-button>
        ...
        <el-button
          ...
          @click="
            batchDelete(scope.selectedListIds)
          "
        >
          批量删除用户
        </el-button>
...
// 自定义渲染表头（使用tsx语法）
const headerRender = (
  scope: HeaderRenderScope<User.ResUserList>
) => {
  return (
    <el-button
      type="primary"
