  ...
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        ...
        >
        一款基于
        Vue3.3、TypeScript、Vite4、Pinia、Element-Plus
    ...
    <div class="card mb10">
      ...
      <el-descriptions :column="2" border>
        ...
        >
          <el-link
            type="primary"
            href="https://gitee.com/HalseySpicy/Geeker-Admin"
            target="_blank"
          >
            Gitee
          </el-link>
...
const { dependencies, devDependencies, version } =
  pkg;
</script>
